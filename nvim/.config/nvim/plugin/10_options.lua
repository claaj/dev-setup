...
vim.o.completeopt = "menuone,noselect,fuzzy,nosort" -- Use custom behaviorpt.clipboard = ""
...
_G.M = function()
	...
	return ({ n = "NOR", i = "INS", v = "VIS", V = "V-L", ["\22"] = "V-B", c = "CMD", R = "REP", s = "SEL", t = "TER" })[m]
		or m
end
_G.DE = function()
...
_G.LSP = function()
	local c = vim.lsp.get_clients({ buf = 0 })[1]
...
vim.o.statusline = " %{v:lua.M()}  %<%f%{&modified?' ':''}%{&readonly?' ':''}"
	.. " %{v:lua.GIT_BRANCH()} %="
